About llama-index-llms-openai-feedstock
=======================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/llama-index-llms-openai-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/llama-index-llms-openai-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add llama-index-llms-openai
# for installing globally
pixi global install llama-index-llms-openai
```
...
It is possible to list all of the versions of `llama-index-llms-openai` available on your platform:
...
```
pixi search llama-index-llms-openai --channel conda-forge
```
